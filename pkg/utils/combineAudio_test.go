...
func TestOverlap(t *testing.T) {
	...
	paths := []string{"../../audio/1811/1811.wav", "../../audio/1824/1852/1808.wav", "../../audio/1836/1845/1845_1.wav"} //path for gleeta, "ܓܠܝܼܬܵܐ"
	overlap(paths, "overlap1.wav")

	paths = []string{"../../audio/1829/1845/1816.wav", "../../audio/1824/1845/1808.wav"} // path for eawla, "ܥܵܘܠܵܐ"
	overlap(paths, "overlap2.wav")

	paths = []string{"../../audio/1834/1848/1818.wav", "../../audio/1819/1845/1808.wav"} // path for rikhta, "ܪܸܚܛܵܐ"
	overlap(paths, "overlap3.wav")

	paths = []string{"../../audio/1836/1842/1824_1.wav", "../../audio/1824/1852/1808.wav", "../../audio/1824/1845/1808.wav"}
	overlap(paths, "overlap4.wav")

	paths = []string{"../../audio/1824/1845/1808.wav", "../../audio/1819/1845/1808.wav"} // path for lata, "ܠܵܛܵܐ"
	overlap(paths, "overlap5.wav")
}
